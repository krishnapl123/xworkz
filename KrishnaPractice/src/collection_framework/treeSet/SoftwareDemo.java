...
public class SoftwareDemo {
	...
	public static void main(String args[]) {
		...
		SoftwareDTO software1=new SoftwareDTO(4,"faceBook",400,1.1,false,true);
		SoftwareDTO software2=new SoftwareDTO(3,"amazon",200,1.2,false,true);
		SoftwareDTO software3=new SoftwareDTO(2,"gpay",300,1.3,true,false);
		SoftwareDTO software4=new SoftwareDTO(1,"paytm",100,1.4,true,false);
