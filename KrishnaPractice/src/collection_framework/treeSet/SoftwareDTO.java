...
public class SoftwareDTO{
		...
		public SoftwareDTO(int softwareId, String name, double price, double version, boolean autoSaveSupported,
				boolean internetApp) {
			super();
		...
		public String toString() {
			return "SoftwareDTO [softwareId=" + softwareId + ", name=" + name + ", price=" + price + ", version="
					+ version + ", autoSaveSupported=" + autoSaveSupported + ", internetApp=" + internetApp + "]\n";
		}
